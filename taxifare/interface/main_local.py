...
# Granted, thanks to TensorFlow datasets you will not always need “chunks” as you can use batch-by-batch dataset loading
# In this challenge, I use the universal method of incrementally fitting in chunks,
# as it applies to any framework, and will prove useful to partially retrain the model with newer data once it is put in production.
